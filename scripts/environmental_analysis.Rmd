...
logger_plots<-plot_grid(temp_plot, light_plot, lux_plot, temp_plot_parents, nrow=4, ncol=1)  

ggsave(filename="figures/environmental/loggers.png", plot=logger_plots, dpi=300, width=9, height=20, units="in")
