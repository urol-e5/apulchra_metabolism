...
#test.file<-read_csv(file="data/pi_curves/POC-391_20200107.csv", skip=1, col_types = cols(.default = "d", Time = "t")) #do this to correct time format issue
...
sa <- read.csv("data/pi_curves/surface_area_photos/surface_area.csv")
...
# Write to output file
write.csv(pr.out, "output/pi_curve_rates.csv")
```
